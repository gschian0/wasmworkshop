...
wasmworkshop::wasmworkshop(const InstanceInfo& info)
...
#if IPLUG_DSP
void wasmworkshop::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void wasmworkshop::ProcessMidiMsg(const IMidiMsg& msg)
{
  mSynth.AddMidiMsgToQueue(msg);
}

void wasmworkshop::OnReset()
{
  mSynth.SetSampleRateAndBlockSize(GetSampleRate(), GetBlockSize());
}

void wasmworkshop::OnParamChange(int paramIdx)
{
