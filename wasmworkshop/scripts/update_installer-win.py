...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=wasmworkshop Demo Installer\n"
      else:
        line="OutputBaseFilename=wasmworkshop Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the wasmworkshop Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the wasmworkshop installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=wasmworkshop Demo installer\n"
     else:
       line="SetupWindowTitle=wasmworkshop installer\n"
